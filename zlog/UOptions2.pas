...
procedure TformOptions2.ClusterComboChange(Sender: TObject);
begin
   buttonClusterSettings.Enabled := True;
...
procedure TformOptions2.buttonClusterSettingsClick(Sender: TObject);
var
   f: TForm;
begin
...
procedure TformOptions2.ZLinkComboChange(Sender: TObject);
begin
...
procedure TformOptions2.BrowsePathClick(Sender: TObject);
var
   strDir: string;
begin
...
procedure TformOptions2.PTTEnabledCheckBoxClick(Sender: TObject);
begin
   if PTTEnabledCheckBox.Checked then begin
      BeforeEdit.Enabled := True;
      AfterEdit.Enabled := True;
...
procedure TformOptions2.radioSo2rClick(Sender: TObject);
var
   n: Integer;
begin
   n := TRadioButton(Sender).Tag;
...
procedure TformOptions2.checkRig1AXvtClick(Sender: TObject);
var
   i, r: integer;
   F: TIntegerDialog;
begin
...
procedure TformOptions2.checkRigXvtClick(Sender: TObject);
var
   r: Integer;
begin
   r := TCheckBox(Sender).Tag;
...
procedure TformOptions2.comboCwPttPortChange(Sender: TObject);
var
   Index: Integer;
   rigno: Integer;
   combo: TComboBox;
...
procedure TformOptions2.comboIcomModeChange(Sender: TObject);
begin
   if comboIcomMode.ItemIndex = 0 then begin
...
procedure TformOptions2.comboRigControlChange(Sender: TObject);
var
   r: Integer;
   cp: TCommPort;
   combo: TComboBox;
...
procedure TformOptions2.comboRig1NameChange(Sender: TObject);
begin
...
procedure TformOptions2.comboRig3NameChange(Sender: TObject);
begin
//   if comboRig2AName.ItemIndex = comboRig2AName.Items.Count - 1 then begin
...
procedure TformOptions2.comboRigA_b19Change(Sender: TObject);
var
   b: TBand;
begin
...
procedure TformOptions2.comboRigA_Antb19Change(Sender: TObject);
var
   b: TBand;
begin
   if Application.MessageBox(PChar(DoYouWantTheFollowingBandsToHaveTheSameSettins), PChar(Application.Title), MB_YESNO or MB_ICONEXCLAMATION) = IDNO then begin
...
procedure TformOptions2.comboRigB_b19Change(Sender: TObject);
var
   b: TBand;
begin
   if Application.MessageBox(PChar(DoYouWantTheFollowingBandsToHaveTheSameSettins), PChar(Application.Title), MB_YESNO or MB_ICONEXCLAMATION) = IDNO then begin
...
procedure TformOptions2.comboRigB_Antb19Change(Sender: TObject);
var
   b: TBand;
begin
   if Application.MessageBox(PChar(DoYouWantTheFollowingBandsToHaveTheSameSettins), PChar(Application.Title), MB_YESNO or MB_ICONEXCLAMATION) = IDNO then begin
...
procedure TformOptions2.checkUseWinKeyerClick(Sender: TObject);
begin
...
procedure TformOptions2.InitRigNames();
begin
...
procedure TformOptions2.buttonPortConfigCWClick(Sender: TObject);
var
   f: TformPortConfig;
   r: Integer;
begin
...
procedure TformOptions2.buttonPortConfigRigClick(Sender: TObject);
var
   f: TformPortConfig;
   r: Integer;
begin
...
procedure TformOptions2.buttonXvtConfigClick(Sender: TObject);
var
   i, r: integer;
   F: TIntegerDialog;
begin
