...
type
  ...
  TSettingsParam = record
    ...
    _bandscope_always_chenge_mode: Boolean;
...
//      Settings._specificcwport := ini.ReadInteger('Hardware', 'UseCWPort', 0 { $037A } );
      ...
      Settings._bandscope_always_chenge_mode := ini.ReadBool('BandScopeOptions', 'always_chenge_mode', False);
...
//      ini.WriteBool('Z-Link', 'COMlocalecho', Settings._zlinklocalechoCOM);
      ...
      ini.WriteBool('BandScopeOptions', 'always_chenge_mode', Settings._bandscope_always_chenge_mode);
