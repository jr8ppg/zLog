...
function acmFormatSuggest(had : HACMDRIVER; const pwfxSrc : PWAVEFORMATEX; pwfxDst : PWAVEFORMATEX; cbwfxDst : DWORD; fdwSuggest : DWORD) : MMRESULT; stdcall;
...
function acmStreamOpen(phas : PHACMSTREAM; had : HACMDRIVER; const pwfxSrc : PWAVEFORMATEX; const pwfxdst : PWAVEFORMATEX; pwfltr : PWAVEFILTER; dwCallback : DWORD; dwInstance : DWORD; fdwOpen : DWORD) : MMRESULT; stdcall;
