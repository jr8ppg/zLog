...
procedure INIT_MMREG_MID(var guid: TGUID; id: USHORT); inline;
{$EXTERNALSYM INIT_MMREG_MID}
function EXTRACT_MMREG_MID(const guid: TGUID): USHORT; inline;
{$EXTERNALSYM EXTRACT_MMREG_MID}
function DEFINE_MMREG_MID_GUID(id: USHORT): TGUID; inline;
{$EXTERNALSYM DEFINE_MMREG_MID_GUID}
function IS_COMPATIBLE_MMREG_MID(const guid: TGUID): Boolean; inline;
{$EXTERNALSYM IS_COMPATIBLE_MMREG_MID}

//{e36dc2ac-6d9a-11d1-a21a-00a0c9223196}
procedure INIT_MMREG_PID(var guid: TGUID; id: USHORT); inline;
{$EXTERNALSYM INIT_MMREG_PID}
function EXTRACT_MMREG_PID(const guid: TGUID): USHORT; inline;
{$EXTERNALSYM EXTRACT_MMREG_PID}
function DEFINE_MMREG_PID_GUID(id: USHORT): TGUID; inline;
{$EXTERNALSYM DEFINE_MMREG_MID_GUID}
function IS_COMPATIBLE_MMREG_PID(const guid: TGUID): Boolean; inline;
{$EXTERNALSYM IS_COMPATIBLE_MMREG_PID}
...
type
  ...
  TPCMWaveForamt = pcmwaveformat_tag;
...
type
  ...
  {$EXTERNALSYM tagWAVEFORMATEX}
  WAVEFORMATEX = tagWAVEFORMATEX;
  {$EXTERNALSYM WAVEFORMATEX}
  TWaveFormatEx = tagWAVEFORMATEX;
(*
#ifdef GUID_DEFINED
...
type
  ...
  TWaveFormatPCMEx = WAVEFORMATEXTENSIBLE;
...
type
  ...
  TWaveFormatIEEEFloatEx = WAVEFORMATEXTENSIBLE;
...
type
  ...
  TADPCMWaveFormat = adpcmwaveformat_tag;
...
type
  ...
  TDRMWaveFormat = drmwaveformat_tag;
...
type
  ...
  TDVIADPCMWaveFormat = dvi_adpcmwaveformat_tag;
...
type
  ...
  TIMAADPCMWaveFormat = ima_adpcmwaveformat_tag;
...
type
  ...
  TMediaSpaceADPCMWaveFormat = mediaspace_adpcmwaveformat_tag;
...
type
  ...
  TSierraADPCMWaveFormat = sierra_adpcmwaveformat_tag;
...
//
type
  PG723ADPCMWaveFormat = ^TG723ADPCMWaveFormat;
  ...
  TG723ADPCMWaveFormat = g723_adpcmwaveformat_tag;
...
type
  ...
  TDIGISTDWaveFormat = digistdwaveformat_tag;
...
type
  ...
  TDIGIFIXWaveFormat = digifixwaveformat_tag;
...
type
  ...
  {$EXTERNALSYM DIALOGICOKIADPCMWAVEFORMAT}
  TDialogicOKIADPCMWaveFormat = creative_fastspeechformat_tag;
...
//
type
  PYamahaADPCMWaveFormat = ^TYamahaADPCMWaveFormat;
  ...
  TYamahaADPCMWaveFormat = yamaha_adpmcwaveformat_tag;
...
type
  ...
  TSONARCWaveFormat = sonarcwaveformat_tag;
...
type
  ...
  TTrueSpeechWaveFormat = truespeechwaveformat_tag;
...
type
  ...
  TEchoSC1WaveFormat = echosc1waveformat_tag;
...
//
type
  PAudioFileAF36WaveFormat = ^TAudioFileAF36WaveFormat;
  ...
  TAudioFileAF36WaveFormat = audiofile_af36waveformat_tag;
...
type
  ...
  TAPTXWaveFormat = aptxwaveformat_tag;
...
//
type
  PAudioFileAF10WaveFormat = ^TAudioFileAF10WaveFormat;
  ...
  TAudioFileAF10WaveFormat = audiofile_af10waveformat_tag;
...
type
  ...
  TDolbyAC2WaveFormat = dolbyac2waveformat_tag;
...
type
  ...
  TGSM610WaveFormat = gsm610waveformat_tag;
...
type
  ...
  TADPCMEWaveFormat = adpcmewaveformat_tag;
...
type
  ...
  TContresVQLPCWaveFormat = contres_vqlpcwaveformat_tag;
...
type
  ...
  TDigirealWaveFormat = digirealwaveformat_tag;
...
type
  ...
  TDigiADPCMWaveFormat = digiadpcmmwaveformat_tag;
...
type
  ...
  TContresCR10WaveFormat = contres_cr10waveformat_tag;
...
//
type
  PNMSVBXADPCMWaveFormat = ^TNMSVBXADPCMWaveFormat;
  ...
  {$EXTERNALSYM NMS_VBXADPCMWAVEFORMAT}
  TNMSVBXADPCMWaveFormat = nms_vbxadpcmmwaveformat_tag;
...
//
type
  PG721ADPCMWaveFormat = ^TG721ADPCMWaveFormat;
  ...
  TG721ADPCMWaveFormat = g721_adpcmwaveformat_tag;
...
type
  ...
  TMPEG1WaveFormat = mpeg1waveformat_tag;
...
type
  ...
  TMPEGLayer3WaveFormat = mpeglayer3waveformat_tag;
...
type
  ...
  THEAACWaveInfo = heaacwaveinfo_tag;
...
type
  ...
  THEAACWaveFormat = heaacwaveformat_tag;
...
type
  ...
  TMSAudio1WaveFormat = msaudio1waveformat_tag;
...
type
  ...
  TWMAudio2WaveFormat = wmaudio2waveformat_tag;
...
type
  ...
  TWMAudio3WaveFormat = wmaudio3waveformat_tag;
...
type
  ...
  TCreativeADPCMWaveFormat = creative_adpcmwaveformat_tag;
...
type
  ...
  TCreativeFastSpeech8WaveFormat = creative_fastspeech8format_tag;
...
type
  ...
  TCreativeFastSpeech10WaveFormat = creative_fastspeech10format_tag;
...
//
type
  PFmTownsSndWaveFormat = ^TFmTownsSndWaveFormat;
  ...
  TFmTownsSndWaveFormat = fmtowns_snd_waveformat_tag;
...
type
  ...
  TOliGSMWaveFormat = oligsmwaveformat_tag;
...
type
  ...
  {$EXTERNALSYM oliadpcmwaveformat_tag}
  OLIADPCMWAVEFORMAT = oliadpcmwaveformat_tag;
  {$EXTERNALSYM OLIADPCMWAVEFORMAT}
  TOliADPCMWaveFormat = oliadpcmwaveformat_tag;
...
type
  ...
  TOliCELPWaveFormat = olicelpwaveformat_tag;
...
type
  ...
  TOliSBCWaveFormat = olisbcwaveformat_tag;
...
type
  ...
  TOliOPRWaveFormat = olioprwaveformat_tag;
...
type
  ...
  TCSIMAADPCMWaveFormat = csimaadpcmwaveformat_tag;
...
type
  ...
  TWaveFilter = wavefilter_tag;

const
  WAVE_FILTER_VOLUME     = $0001;
  {$EXTERNALSYM WAVE_FILTER_VOLUME}
...
type
  ...
  TVolumeWaveFilter = wavefilter_volume_tag;
...
type
  ...
  TEchoWaveFilter = wavefilter_echo_tag;
...
begin
  INIT_MMREG_MID(Result, id);
end;

function IS_COMPATIBLE_MMREG_MID(const guid: TGUID): Boolean;
begin
  Result :=
    (guid.D1 >= $d5a47fa7) and
...
begin
  INIT_MMREG_PID(Result, id);
end;

function IS_COMPATIBLE_MMREG_PID(const guid: TGUID): Boolean; inline;
begin
  Result :=
    (guid.D1 >= $e36dc2ac) and
